...
import { Box, Bird, Cat, Rabbit, Users, Code2, Wand2, Hammer, FolderOpen, ChevronUp, FileJson, History, Play, Pause, Info, Wrench, Loader2, Image as ImageIcon, Download } from 'lucide-react';
      ...
      <div className="absolute top-4 left-4 right-4 flex justify-between items-start">
        ...
        <div className="pointer-events-auto flex flex-col gap-2">
            <DropdownMenu 
                ...
                color="indigo"
            >
                <div className="px-2 py-1 text-xs font-bold text-slate-400 uppercase tracking-wider">MODELS</div>
                ...
                <div className="px-2 py-1 text-xs font-bold text-indigo-400 uppercase tracking-wider">CREATIVE TOOLS</div>
                <DropdownItem onClick={onOpenImageStudio} icon={<ImageIcon size={16} className="text-indigo-500" />} label="Concept Studio" highlight />
                ...
                <DropdownItem onClick={onSaveLocally} icon={<Download size={16}/>} label="Save Locally" highlight />
            </DropdownMenu>
