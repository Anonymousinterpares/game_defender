...
export const MasterConfig: GameConfigSchema = {
  ...
  Lighting: {
    ...
    fireLightRadius: { value: 350, type: 'number', description: 'Radius of fire light clusters' },
    fireLightIntensity: { value: 2.5, type: 'number', description: 'Brightness of fire sources' },
    fireLightShadowRange: { value: 60, type: 'number', description: 'Shadow range for fire lights (Tiles)' },
