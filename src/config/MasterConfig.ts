...
export const MasterConfig: GameConfigSchema = {
  ...
  TimeSystem: {
    ...
    startHour: { value: 8, type: 'number', description: 'Starting game hour (0-23)' },
  ...
  Weather: {
    initialWeather: { value: 'clear', type: 'string', description: 'Initial weather type (clear, fog, rain, snow, random)' },
